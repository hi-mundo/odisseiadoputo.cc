...
> **Atualização / Correção:** Na primeira versão deste artigo, o texto dava a entender que a Apple estava banindo apps *feitos* por IA. Para ser tecnicamente exato: a Apple está banindo e removendo da loja aplicativos que **funcionam como ferramentas de vibe coding** (como "Anything", "Vibecode" e similares, onde o usuário usa IA para gerar e rodar código direto no celular). A justificativa oficial da Apple para a remoção é a **Guideline 2.5.2**, que proíbe estritamente aplicativos de baixarem, instalarem ou executarem código externo que altere os recursos do app. O erro de semântica foi corrigido, mas a ironia central segue intacta: a Apple usa a Diretriz 2.5.2 para te proibir de gerar e rodar código via IA no ecossistema dela, enquanto usa a IA da concorrência nos bastidores para programar os próprios aplicativos.
